...
import { MutableAspectDefImpl, ImmutableAspectDefImpl, FullAspectDefImpl } from "./AspectDefImpl.js";
...
describe("AspectDefHash", () => {
  it("hash_IdenticalFullAndMutableAspectDefs_ProduceSameHash", () => {
    ...
    const mutableAspectDef = new MutableAspectDefImpl("testAspect", globalId, new Map(propertyDefs));
  ...
  it("hash_IdenticalFullAndImmutableAspectDefs_ProduceSameHash", () => {
    ...
    const immutableAspectDef = new ImmutableAspectDefImpl("testAspect", globalId, new Map(propertyDefs));
