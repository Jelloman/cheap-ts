...
describe("AspectPropertyMapBuilder", () => {
  ...
  beforeEach(() => {
    ...
    nullablePropDef = new PropertyDefImpl(
      "nullableProp",
      PropertyType.String,
      null,
      false,
  ...
  describe("property with Property object", () => {
    ...
    it("should throw exception for property with mismatched definition", () => {
      const differentDef = new PropertyDefImpl(
        "stringProp",
        PropertyType.String,
        null,
        false,
  ...
  describe("build", () => {
    ...
    it("should create aspect with entity", () => {
      const result = builder.entity(entity).aspectDef(aspectDef).property("stringProp", "test-value").build();
    ...
    it("should create aspect with property objects", () => {
      const result = builder.entity(entity).aspectDef(aspectDef).property(stringProperty).property(intProperty).build();
    ...
    it("should create aspect with nullable property", () => {
      const result = builder.entity(entity).aspectDef(aspectDef).property("nullableProp", null).build();
  ...
  describe("reset", () => {
    it("should clear all state", () => {
      builder.entity(entity).aspectDef(aspectDef).property("stringProp", "test-value");
    ...
    it("should allow reuse", () => {
      // Build first aspect
      const aspect1 = builder.entity(entity).aspectDef(aspectDef).property("stringProp", "value1").build();

      // Reset and build second aspect
      const entity2 = new EntityImpl();
      const aspect2 = builder.reset().entity(entity2).aspectDef(aspectDef).property("stringProp", "value2").build();
