...
describe("PropertyDefImpl", () => {
  ...
  describe("equals", () => {
    it("should return true for same name (different type)", () => {
      const propDef1 = new PropertyDefBuilder().setName("testProp").setType(PropertyType.String).build();
      const propDef2 = new PropertyDefBuilder().setName("testProp").setType(PropertyType.Integer).build();
    ...
    it("should return false for different names", () => {
      const propDef1 = new PropertyDefBuilder().setName("testProp1").setType(PropertyType.String).build();
      const propDef2 = new PropertyDefBuilder().setName("testProp2").setType(PropertyType.String).build();
  ...
  describe("fullyEquals", () => {
    it("should return true for identical instances constructed separately", () => {
      const propDef1 = new PropertyDefBuilder().setName("testProp").setType(PropertyType.String).build();
      const propDef2 = new PropertyDefBuilder().setName("testProp").setType(PropertyType.String).build();
