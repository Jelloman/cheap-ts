...
describe("MutableAspectDefImpl", () => {
  ...
  describe("add", () => {
    ...
    it("should return old property when replacing existing property", () => {
      const aspectDef = new MutableAspectDefImpl("testAspect", crypto.randomUUID(), propertyDefs);
      const newProp = new PropertyDefBuilder().setName("prop1").setType(PropertyType.Boolean).build();
  ...
  describe("remove", () => {
    ...
    it("should remove property with same name", () => {
      const aspectDef = new MutableAspectDefImpl("testAspect", crypto.randomUUID(), propertyDefs);
      const differentPropSameName = new PropertyDefBuilder().setName("prop1").setType(PropertyType.Float).build();
  ...
  describe("property with special name", () => {
    it("should handle add with special name", () => {
      const aspectDef = new MutableAspectDefImpl("testAspect", crypto.randomUUID());
      const specialProp = new PropertyDefBuilder().setName("_special_").setType(PropertyType.String).build();
  ...
  describe("fullyEquals", () => {
    it("should return false for identical instances with different UUIDs", () => {
      ...
      propertyDefs1.set("prop1", new PropertyDefBuilder().setName("prop1").setType(PropertyType.String).build());
      propertyDefs1.set("prop2", new PropertyDefBuilder().setName("prop2").setType(PropertyType.Integer).build());

      const propertyDefs2 = new Map<string, PropertyDef>();
      propertyDefs2.set("prop1", new PropertyDefBuilder().setName("prop1").setType(PropertyType.String).build());
      propertyDefs2.set("prop2", new PropertyDefBuilder().setName("prop2").setType(PropertyType.Integer).build());
    ...
    it("should return true for same instance", () => {
      ...
      propertyDefs.set("prop1", new PropertyDefBuilder().setName("prop1").setType(PropertyType.String).build());
      propertyDefs.set("prop2", new PropertyDefBuilder().setName("prop2").setType(PropertyType.Integer).build());
...
describe("ImmutableAspectDefImpl", () => {
  ...
  describe("constructor", () => {
    it("should create immutable aspect def with properties", () => {
      const aspectDef = new ImmutableAspectDefImpl("testAspect", crypto.randomUUID(), propertyDefs);
